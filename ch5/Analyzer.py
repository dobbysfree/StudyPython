...
class MarketDB:
    def __init__(self):
        ...
        self.conn = pymysql.connect(host='192.168.1.96', port=8706, db='db_study', user='devasaq', passwd='ZXCdsaqwe321!', charset='utf8')
        self.codes = {}
        self.get_comp_info()
    ...
    def get_daily_price(self, code, start_date=None, end_date=None):
        if (start_date is None):
            ...
            if start_year < 1900 or start_month > 2200:
